...
if (typeof(Storage) !== "undefined") {
  $(document).on("change", "#stf-valg", function() {
    ...
    $("#banner-form-login").attr("href", v && "https://www.kursadmin.org/pls/kas/f?p=" + v).attr("disabled", !!!v);
    $("#banner-form-login-test").attr("href", v && "http://test.senitel.no/pls/kastest/f?p=" + v).attr("disabled", !!!v);
